...
class DrawingUtil {
    ...
    static drawBlackSqLineUp(context : CanvasRenderingContext2D, scale : number) {
    ...
    static drawBSLUNode(context : CanvasRenderingContext2D, i : number, scale : number) {
        context.lineCap = 'round'
        context.lineWidth = Math.min(w, h) / strokeFactor 
        context.strokeStyle = colors[i]
        context.fillStyle = colors[i]
        DrawingUtil.drawBlackSqLineUp(context, scale)
    }
}
