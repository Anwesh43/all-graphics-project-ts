...
class DrawingUtil {
    ...
    static drawRectSideUpRot(context : CanvasRenderingContext2D, scale : number) {
    ...
    static drawRSURNode(context : CanvasRenderingContext2D, i : number, scale : number) {
        ...
        DrawingUtil.drawRectSideUpRot(context, scale)
    }
}
...
class RSURNode {
    ...
    getNext(dir : number, cb : () => void) : RSURNode {
...
class RectSideRectUp {

    curr : RSURNode = new RSURNode(0)
    dir : number = 1
...
class Renderer {
    ...
    rsur : RectSideRectUp = new RectSideRectUp()
