...
class DrawingUtil {
    ...
    static drawLineSlantRotDown(context : CanvasRenderingContext2D, scale : number) {
        ...
        DrawingUtil.drawXY(context, w / 2, h / 2, () => {
            for (let j = 0; j < 2; j++) {
                DrawingUtil.drawXY(context, 0, 0 , () => {
                    ...
                    for (let k = 0; k < 2; k++) {
                        DrawingUtil.drawXY(context, 0, 0, () => {
                            context.rotate((rot / (k + 1)) * (1 - 2 * k) * dsc(k + 1))
    ...
    static drawLSRDNode(context : CanvasRenderingContext2D, i : number, scale : number) {
        ...
        DrawingUtil.drawLineSlantRotDown(context, scale)
    }
}
...
class Renderer {
    ...
    lsrd : LineSlantRotDown = new LineSlantRotDown()
