...
class DrawingUtil {
    ...
    static drawLineRotPeak(context: CanvasRenderingContext2D, scale: number) {
    ...
    static drawLJRPNode(context: CanvasRenderingContext2D, i: number, scale: number) {
        ...
        DrawingUtil.drawLineRotPeak(context, scale)
    }
}
...
class LineJoinRotPeak {

    curr: LJRPNode = new LJRPNode(0)
    dir: number = 1
