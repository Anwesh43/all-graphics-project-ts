...
class DrawingUtil {
    ...
    static drawSquareLineRotRight(context : CanvasRenderingContext2D, scale : number) {
        ...
        DrawingUtil.drawXY(context, w / 2, h / 2, () => {
            ...
            DrawingUtil.drawXY(context, size + (w / 2) * dsc(2), 0, () => {
    ...
    static drawSLRRNode(context : CanvasRenderingContext2D, i : number, scale : number) {
        ...
        DrawingUtil.drawSquareLineRotRight(context, scale)
    }
}
...
class SquareLineRotRight {

    curr : SLRRNode = new SLRRNode(0)
    dir : number = 1
