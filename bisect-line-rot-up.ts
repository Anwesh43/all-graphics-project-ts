...
class DrawingUtil {
    ...
    static drawBisectLineRot(context: CanvasRenderingContext2D, scale: number) {
    ...
    static drawBLRNode(context: CanvasRenderingContext2D, i: number, scale: number) {
        ...
        DrawingUtil.drawBisectLineRot(context, scale)
    }
}
