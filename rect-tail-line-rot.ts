...
class DrawingUtil {
    ...
    static drawRectTailLineRot(context : CanvasRenderingContext2D, scale : number) {
    ...
    static drawRTLRNode(context : CanvasRenderingContext2D, i : number, scale : number) {
        ...
        DrawingUtil.drawRectTailLineRot(context, scale)
    }
}
