...
class DrawingUtil {
    ...
    static drawSLJRNode(context: CanvasRenderingContext2D, i: number, scale: number) {
        context.lineCap = 'round'
        context.lineWidth = Math.min(w, h) / strokeFactor
        context.strokeStyle = colors[i]
        DrawingUtil.drawSlantLineJoinRot(context, scale)
    }
}
...
class SlantLineJoinRot {

    curr: SLJRNode = new SLJRNode(0)
    dir: number = 1
