...
class DrawingUtil {
    ...
    static drawLineSlantRight(context : CanvasRenderingContext2D, scale : number) {
    ...
    static drawLSRNode(context : CanvasRenderingContext2D, i : number, scale : number) {
        ...
        DrawingUtil.drawLineSlantRight(context, scale)
    }
}
...
class Renderer {
    ...
    lsr : LineSlantRight = new LineSlantRight()
