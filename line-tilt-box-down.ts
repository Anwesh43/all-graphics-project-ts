...
class DrawingUtil {
    ...
    static drawLineTiltBoxDown(context: CanvasRenderingContext2D, scale: number) {
        ...
        DrawingUtil.drawXY(context, w / 2, h / 2 + (h / 2) * dsc(3), () => {
            for (let j = 0; j < 2; j++) {
                DrawingUtil.drawXY(context, 0, 0, () => {
                    ...
                    DrawingUtil.drawXY(context, size + (w / 2 - size) * (1 - dsc(0)), 0, () => {
    ...
    static drawLTBDNode(context: CanvasRenderingContext2D, i: number, scale: number) {
        ...
        DrawingUtil.drawLineTiltBoxDown(context, scale)
    }
}
