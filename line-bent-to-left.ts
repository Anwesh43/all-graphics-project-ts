...
class DrawingUtil {
    ...
    static drawLBTLNode(context: CanvasRenderingContext2D, i: number, scale: number) {
        context.lineCap = 'round'
        context.lineWidth = Math.min(w, h) / strokeFactor
        context.strokeStyle = colors[i]
        DrawingUtil.drawLineBentToLeft(context, scale)
    }
}
...
class LineBentToLeft {

    curr: LBTLNode = new LBTLNode(0)
    dir: number = 1
